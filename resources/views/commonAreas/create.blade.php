        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Nuevo &aacute;rea com&uacute;n</h3>
                </div>
                <!--form start-->
                {!! Form::open(['route' => 'commonAreas.store', 'method' => 'POST']) !!}
                    <div class="box-body">
                        <!--first name--> 
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label>Area:</label>
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Area', 'maxlength' => '30']) !!}
                            @if ($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('price_one') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('price_one', null, ['class' => 'form-control', 'placeholder' => 'Precio uno', 'maxlength' => '9']) !!}
                        ...
                        <div class="form-group {{ $errors->has('price_two') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('price_two', null, ['class' => 'form-control', 'placeholder' => 'Precio dos', 'maxlength' => '9']) !!}
