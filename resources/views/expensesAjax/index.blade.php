...
<script>
  ...
  $(document).ready(function(){
      ...
      $('#create_activity_one').click(function(){
          ...
          var route = '{{ route('expensesAjax.create', 'annual_estimation_id')}}';
          $.get(route, function(){
      ...
      $('#store_activity').click(function(){
          ...
          var token = $('#token').val();
          var route = '{{ route('expensesAjax.store')}}';
...
function loadData()
{
      ...
      var route = '{{ route('expensesAjax.listing', 'id')}}';
      var countOne = 0;
      var countTwo = 0;
...
//              console.log('entra ' + value.name);
              if(value.type === 1){
                tableDataOne.append('<tr><td>'+ value.name +'</td><td>'+ value.annual +'</td><td>'+ value.january  +'</td><td>'+ value.february +'</td><td>'+ value.march +'</td><td>'+ value.april +'</td><td>'+ value.may +'</td><td>'+ value.june +'</td><td>'+ value.july +'</td><td>'+ value.august +'</td><td>'+ value.september +'</td><td>'+ value.octuber +'</td><td>'+ value.november +'</td><td>'+ value.december +'</td><th><button class="btn btn-link btn-xs" value="' + value.expense_id + '" onclick= "UpdateActivityOne(this, '+ countOne +')" title="Guardar cambios" ><span class="label label-success"><i class="fa fa-check"></i></span></button><button class="btn btn-link btn-xs" value="' + value.expense_id + '" onclick= "DeleteActivity(this)" title="Eliminar concepto"><span class="label label-danger"><i class="fa fa-trash-o"></i></span></button></th></tr>');
                countOne++;
              }
              if(value.type === 2){
                tableDataTwo.append('<tr><td>'+ value.name +'</td><td>'+ value.annual +'</td><td>'+ value.january  +'</td><td>'+ value.february +'</td><td>'+ value.march +'</td><td>'+ value.april +'</td><td>'+ value.may +'</td><td>'+ value.june +'</td><td>'+ value.july +'</td><td>'+ value.august +'</td><td>'+ value.september +'</td><td>'+ value.octuber +'</td><td>'+ value.november +'</td><td>'+ value.december +'</td><th><button class="btn btn-link btn-xs" value="' + value.expense_id + '" onclick= "UpdateActivityTwo(this, '+ countTwo +')" title="Guardar cambios"><span class="label label-success"><i class="fa fa-check"></i></span></button><button class="btn btn-link btn-xs" value="' + value.expense_id + '" onclick= "DeleteActivity(this)" title="Eliminar concepto"><span class="label label-danger"><i class="fa fa-trash-o"></i></span></button></th></tr>');
                countTwo++;
              }
...
function UpdateActivityOne(btn, count)
{
    ...
    var token = $('#token').val();
    var route = '{{ route('expensesAjax.update', 'id')}}';
...
function DeleteActivity(btn)
{
    ...
    if(result){
        ...
        var token = $('#token').val();
        var route = '{{ route('expensesAjax.destroy', ['annual_estimation_id', 'id'])}}';
