...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('blocks.index') }}"> Bloques</a></li>
    </ol>
</section>
        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Nuevo Bloque</h3>
                </div>
                <!--form start-->
                {!! Form::open(['route' => 'blocks.store', 'method' => 'POST']) !!}
                    <div class="box-body">
                        <!--first name--> 
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label>Bloque:</label>
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Bloque', 'maxlength' => '30']) !!}
                            @if ($errors->has('name'))
