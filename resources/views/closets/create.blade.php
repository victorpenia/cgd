        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Nueva baulera</h3>
                </div>
                <!--form start-->
                {!! Form::open(['route' => ['closets.store', $place_closet_id], 'method' => 'POST']) !!}
                    <div class="box-body">
                        <!--first name--> 
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label>Baulera:</label>
                            {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Baulera', 'maxlength' => '30']) !!}
                            @if ($errors->has('name'))
