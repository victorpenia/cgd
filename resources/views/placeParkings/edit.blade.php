        ...
        <div class="col-md-8">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Editar zona de parqueo</h3>
                </div>
                 <!--/.box-header--> 
                 <!--form start--> 
                <!--<form role="form">-->
                {!! Form::open(['route' => ['placeParkings.update', $place_parking->id], 'method' => 'PUT']) !!}
                    <div class="box-body">
                        <div class="form-group">
                            {!! Form::hidden('id', $place_parking->id, ['class' => 'form-control']) !!}
                        </div>
                    <!--first name--> 
                        <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label>Zona de parqueo:</label>
                            {!! Form::text('name', $place_parking->name, ['class' => 'form-control', 'placeholder' => 'Zona de parqueo', 'maxlength' => '30']) !!}
                            @if ($errors->has('name'))
